...
public final class StatusPlugin extends Plugin {
  ...
  public List<DataType> getDataTypes() {
    return List.of(com.team2073.KeyboardInputStatus.StatusDataType.instance);
  }
  ...
  public Map<DataType, ComponentType> getDefaultComponents() {
    return Map.of(com.team2073.KeyboardInputStatus.StatusDataType.instance, WidgetType.forAnnotatedWidget(StatusWidget.class));
  }
}
